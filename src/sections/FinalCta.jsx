...
export default function FinalCta() {
  ...
  return (
    <section ref={pauseRef} id="contact" className="relative px-3 py-12 md:px-6 md:py-28 lg:pb-[clamp(64px,5vw,88px)] lg:pt-[clamp(32px,3vw,48px)]" aria-labelledby="contact-title">
      <div className="relative mx-auto max-w-[1400px] overflow-hidden rounded-[32px] border border-white/[.08] bg-[radial-gradient(120%_90%_at_50%_0%,#0d3a78_0%,#08203f_40%,#040f1d_100%)] px-5 py-16 text-center md:rounded-[48px] md:py-36 lg:py-[clamp(96px,8vw,128px)]">
        <div aria-hidden="true" className="absolute inset-0">
          ...
          <div className="absolute left-1/2 top-[-45%] h-[90%] w-[110%] -translate-x-1/2 bg-[radial-gradient(closest-side,rgba(0,209,255,.2),transparent)]" />
